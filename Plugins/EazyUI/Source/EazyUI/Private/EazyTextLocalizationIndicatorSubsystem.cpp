#include "EazyTextLocalizationIndicatorSubsystem.h"
...
namespace EazyTextLocalizationIndicatorSubsystem
{
	constexpr const TCHAR* EazyTextLocalizationIndicatorName = TEXT("EazyTextLocalizationIndicator");
	static TCustomShowFlag<EShowFlagShippingValue::ForceDisabled> EazyTextLocalizationIndicatorShowFlag(
		EazyTextLocalizationIndicatorName,
		false);
	...
	static void EazyTextLocalizationIndicatorDraw(UCanvas* Canvas, APlayerController* Controller)
	{
...
void UEazyTextLocalizationIndicatorSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	using namespace EazyTextLocalizationIndicatorSubsystem;
	DebugDrawDelegate = UDebugDrawService::Register(EazyTextLocalizationIndicatorName, FDebugDrawDelegate::CreateStatic(EazyTextLocalizationIndicatorDraw));
}

void UEazyTextLocalizationIndicatorSubsystem::Deinitialize()
{
