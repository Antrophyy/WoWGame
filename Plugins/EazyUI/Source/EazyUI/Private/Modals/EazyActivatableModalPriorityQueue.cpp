...
void UEazyActivatableModalPriorityQueue::OnWidgetAddedToList(UCommonActivatableWidget& AddedWidget)
{
	...
	{
		const UEazyGameDialog* DialogA = Cast<UEazyGameDialog>(&A);
		const UEazyGameDialog* DialogB = Cast<UEazyGameDialog>(&B);
