...
#include "EazyClassValidation.generated.h"
...
// Supports only generic properties that the UI is using. If a property type is not supported, feel free to add it or override ValidateCompiledDefaults yourself in the project.
UCLASS(ClassGroup=UI)
class EAZYUI_API UEazyClassValidation : public UObject
{
	GENERATED_BODY()
