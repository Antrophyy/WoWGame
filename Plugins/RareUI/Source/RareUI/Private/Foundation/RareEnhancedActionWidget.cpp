...
#include "RareWidgetPaletteCategories.h"
...
TSharedRef<SWidget> URareEnhancedActionWidget::RebuildWidget()
{
...
void URareEnhancedActionWidget::ReleaseSlateResources(const bool bReleaseChildren)
{
...
FSlateBrush URareEnhancedActionWidget::GetIcon() const
{
	if (!IsDesignTime())
	{
...
FText URareEnhancedActionWidget::GetActionDisplayText() const
{
...
bool URareEnhancedActionWidget::IsInteractionEnabled() const
{
	return bInteractionEnabled;
}

bool URareEnhancedActionWidget::IsHeldAction() const
{
	if (IsValid(RepresentedEnhancedInputAction))
	{
...
void URareEnhancedActionWidget::SetEnhancedInputAction(UInputAction* InInputAction, const int32 KeyIndex)
{
...
#if WITH_EDITOR
void URareEnhancedActionWidget::SetDesignTimeKey(const FKey& InDesignTimeKey)
{
	if (IsDesignTime())
	{
#if WITH_EDITORONLY_DATA
...
void URareEnhancedActionWidget::OnWidgetRebuilt()
{
...
void URareEnhancedActionWidget::OnEnhancedActionHeld(const FInputActionInstance& Instance)
{
	...
	{
		ensureMsgf(false, TEXT("URareEnhancedActionWidget::OnEnhancedActionHeld called with EnhancedHoldActionHoldTime > 0. This should not happen, as the hold time should be set to 0 when the action is held. Please check your input action configuration."));
		return;
	}
...
void URareEnhancedActionWidget::OnEnhancedActionReset(const FInputActionInstance&)
{
	OnActionComplete();
}

void URareEnhancedActionWidget::OnEnhancedActionCompleted(const FInputActionInstance&)
{
	OnActionComplete();
}

void URareEnhancedActionWidget::RegisterEnhancedInputControlMappingRebuilt()
{
...
bool URareEnhancedActionWidget::InputActionContainsHoldTrigger() const
{
...
bool URareEnhancedActionWidget::InputMappingContextContainsHoldTrigger() const
{
...
void URareEnhancedActionWidget::ReplaceIconWithActionDisplayName()
{
	const UCommonInputSubsystem* CommonInputSubsystem = GetInputSubsystem();
...
bool URareEnhancedActionWidget::ShouldUpdateActionWidgetIcon() const
{
...
void URareEnhancedActionWidget::HandleControlMappingsRebuilt()
{
	UpdateActionWidget();
}

void URareEnhancedActionWidget::UpdateProgressMaterialStyle()
{
	if (!IsDesignTime())
	{
...
void URareEnhancedActionWidget::BuildMaterial(TObjectPtr<UMaterialInstanceDynamic>& InProgressDynamicMaterial, FSlateBrush& ProgressSlateBrush)
{
