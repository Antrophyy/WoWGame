...
#if WITH_EDITOR
void URareClassValidation::ValidateCompiledDefaultsForClass(const UUserWidget* InWidgetToValidate, IWidgetCompilerLog& InCompileLog)
{
...
bool URareClassValidation::IsPropertyValid(const FProperty* Property, const UUserWidget* Widget)
{
...
bool URareClassValidation::IsPropertyValid_SoftObject(const FSoftObjectProperty* Property, const UUserWidget* Widget)
{
	const FSoftObjectPtr* SoftObject = Property->GetPropertyValuePtr_InContainer(Widget);
	return !SoftObject->IsNull();
}

bool URareClassValidation::IsPropertyValid_SoftClass(const FSoftClassProperty* Property, const UUserWidget* Widget)
{
	const FSoftObjectPtr* SoftClass = Property->GetPropertyValuePtr_InContainer(Widget);
	return !SoftClass->IsNull();
}

bool URareClassValidation::IsPropertyValid_SubClass(const FClassProperty* Property, const UUserWidget* Widget)
{
	const UClass* SubClass = Property->GetPropertyValue_InContainer(Widget).GetClass();
	return IsValid(SubClass);
}

bool URareClassValidation::IsPropertyValid_Object(const FObjectPropertyBase* Property, const UUserWidget* Widget)
{
	const UObject* Object = Property->GetObjectPropertyValue_InContainer(Widget);
	return IsValid(Object);
}

bool URareClassValidation::IsPropertyValid_Struct(const FStructProperty* Property, const UUserWidget* Widget)
{
...
bool URareClassValidation::IsPropertyValid_Enum(const FEnumProperty* Property, const UUserWidget* Widget)
{
...
void URareClassValidation::ReportValidationError(IWidgetCompilerLog& CompileLog, const UUserWidget* Widget, const FProperty* Property)
{
